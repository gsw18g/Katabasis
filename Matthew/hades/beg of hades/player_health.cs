...
public class player_health : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        hades_melee = hades.hades_melee;

        if (take_damage || bat_melee || hades_melee)
        {
            player_damage();
        }
   ...
   public void player_damage()
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.transform.CompareTag("hades_range"))
        {
            hades_melee = true;
            Debug.Log("hades range = true");
        }
